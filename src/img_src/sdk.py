...
import httpx
from img_src import models, utils
from img_src._hooks import SDKHooks
from img_src.types import OptionalNullable, UNSET
import importlib
import sys
...
if TYPE_CHECKING:
    from img_src.images import Images
    from img_src.presets import Presets
    from img_src.settings import Settings
    from img_src.usage import Usage


class Imgsrc(BaseSDK):
    r"""img-src API: Image processing and delivery API.
    ...
    images: "Images"
    _sub_sdk_map = {
        "settings": ("img_src.settings", "Settings"),
        "presets": ("img_src.presets", "Presets"),
        "usage": ("img_src.usage", "Usage"),
        "images": ("img_src.images", "Images"),
    }
